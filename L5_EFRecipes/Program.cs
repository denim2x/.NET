...
namespace L5_EFRecipes {
  class Program {
    static void Main(string[] args) {
      Console.WriteLine("Test EF Code First");
      TestProductContext();
      TestPhotographContext();
      TestBusinessContext();
      TestEmployeeContext();
      Console.ReadKey();
    }

    static void TestProductContext() {
      Console.WriteLine("Test ProducContext");
    ...
    static void TestPhotographContext() {
      Console.WriteLine("Test PhotographContext");
    ...
    static void TestBusinessContext() {
      Console.WriteLine("Test BusinessContext");
    ...
    static void TestEmployeeContext() {
      Console.WriteLine("Test EmployeeContext");
